...
#define GPIO_TEST1    14 //Chaarging
#define GPIO_TEST2    12 //Chaarging
...
#define GPIO_OUTPUT_PIN_SEL  ((1ULL<<GPIO_Green_LED) | (1ULL<<GPIO_Blue_LED)| (1ULL<<GPIO_Red_LED) | (1ULL<<GPIO_LED_EN) | (1ULL<<GPIO_Heater_Ctrl)| (1ULL<<GPIO_TEST1)| (1ULL<<GPIO_TEST2))
